...
<div class="container-fluid">
    ...
    <div class="mb-4">
        <h2 class="fw-bold text-dark">Registrar Nuevo Lote</h2>
        <p class="text-muted">Gestiona la información de tus lotes de forma eficiente</p>
    </div>
            ...
            <form action="{{ route('plots.store') }}" method="POST">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control shadow-sm" id="area_hectares" name="area_hectares" step="0.01" min="0" value="{{ old('area_hectares') }}" required>
                    </div>

                    <div class="col-md-6">
                        <label for="status" class="form-label fw-semibold">Estado</label>
                        <input type="text" class="form-control shadow-sm" id="status" name="status" value="{{ old('status') }}" required>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="farm_id" id="farm_id" class="form-select shadow-sm" required>
                            <option value="" disabled {{ old('farm_id') ? '' : 'selected' }}>Seleccione una finca</option>
                ...
                <div class="d-flex justify-content-end mt-5">
                    ...
                    <button type="submit" class="btn btn-agro px-4">Guardar Lote</button>
                </div>
            </form>
        </div>
    </div>
